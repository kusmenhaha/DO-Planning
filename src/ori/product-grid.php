...
<?php include 'partials/main-nav.php'; ?>
                                    ...
                                    <div class="row justify-content-between align-items-center">
                                         ...
                                         <div class="col-lg-6">
                                              <div class="text-md-end mt-3 mt-md-0">
                                                   ...
                                                   <a href="product-add.php" class="btn btn-success me-1"><i class="bx bx-plus"></i> New Product</a>
                                              </div>
                                         </div>
                                    </div>
                               </div>
                          ...
                          <div class="row">
                               <div class="col-md-6 col-xl-3">
                                    <div class="card">
                                         ...
                                         <div class="card-body bg-light-subtle rounded-bottom">
                                              <a href="product-details.php" class="text-dark fw-medium fs-16">Men Black Slim Fit T-shirt</a>
                                              <div class="my-1">
                                              ...
                                              <div class="mt-3">
                                                   <div class="d-flex gap-2">
                                                        ...
                                                        <a href="order-cart.php" class="btn btn-outline-dark border border-secondary-subtle d-flex align-items-center justify-content-center gap-1 w-100"><i class='bx bx-cart align-middle'></i> Add To Cart</a>
                                                   </div>
                                              </div>
                                         </div>
                               ...
                               <div class="col-md-6 col-xl-3">
                                    <div class="card">
                                         ...
                                         <div class="card-body bg-light-subtle rounded-bottom">
                                              <a href="product-details.php" class="text-dark fw-medium fs-16">Olive Green Leather Bag</a>
                                              <div class="my-1">
                                                   <div class="d-flex gap-2 align-items-center">
                                                        <ul class="d-flex text-warning m-0 fs-18  list-unstyled">
                                                             <li>
                               ...
                               <div class="col-md-6 col-xl-3">
                                    <div class="card">
                                         ...
                                         <div class="card-body bg-light-subtle rounded-bottom">
                                              <a href="product-details.php" class="text-dark fw-medium fs-16">Women Golden Dress</a>
                                              <div class="my-1">
                                                   <div class="d-flex gap-2 align-items-center">
                                                        <ul class="d-flex text-warning m-0 fs-18  list-unstyled">
                                                             <li>
                               ...
                               <div class="col-md-6 col-xl-3">
                                    <div class="card">
                                         ...
                                         <div class="card-body bg-light-subtle rounded-bottom">
                                              <a href="product-details.php" class="text-dark fw-medium fs-16">Gray Cap For Men</a>
                                              <div class="my-1">
                                                   <div class="d-flex gap-2 align-items-center">
                                                        <ul class="d-flex text-warning m-0 fs-18  list-unstyled">
                                                             <li>
                               ...
                               <div class="col-md-6 col-xl-3">
                                    <div class="card">
                                         ...
                                         <div class="card-body bg-light-subtle rounded-bottom">
                                              <a href="product-details.php" class="text-dark fw-medium fs-16">Dark Green Cargo Pent</a>
                                              <div class="my-1">
                                                   <div class="d-flex gap-2 align-items-center">
                                                        <ul class="d-flex text-warning m-0 fs-18  list-unstyled">
                                                             <li>
                               ...
                               <div class="col-md-6 col-xl-3">
                                    <div class="card">
                                         ...
                                         <div class="card-body bg-light-subtle rounded-bottom">
                                              <a href="product-details.php" class="text-dark fw-medium fs-16">Orange Headphone</a>
                                              <div class="my-1">
                                                   <div class="d-flex gap-2 align-items-center">
                                                        <ul class="d-flex text-warning m-0 fs-18  list-unstyled">
                                                             <li>
                               ...
                               <div class="col-md-6 col-xl-3">
                                    <div class="card">
                                         ...
                                         <div class="card-body bg-light-subtle rounded-bottom">
                                              <a href="product-details.php" class="text-dark fw-medium fs-16">Kid's Yellow Shoes</a>
                                              <div class="my-1">
                                                   <div class="d-flex gap-2 align-items-center">
                                                        <ul class="d-flex text-warning m-0 fs-18  list-unstyled">
                                                             <li>
                               ...
                               <div class="col-md-6 col-xl-3">
                                    <div class="card">
                                         ...
                                         <div class="card-body bg-light-subtle rounded-bottom">
                                              <a href="product-details.php" class="text-dark fw-medium fs-16">Men Dark Brown Wallet</a>
                                              <div class="my-1">
                                                   <div class="d-flex gap-2 align-items-center">
                                                        <ul class="d-flex text-warning m-0 fs-18  list-unstyled">
                                                             <li>
                               ...
                               <div class="col-md-6 col-xl-3">
                                    <div class="card">
                                         ...
                                         <div class="card-body bg-light-subtle rounded-bottom">
                                              <a href="product-details.php" class="text-dark fw-medium fs-16">Sky Blue Mat Sunglass</a>
                                              <div class="my-1">
                                                   <div class="d-flex gap-2 align-items-center">
                                                        <ul class="d-flex text-warning m-0 fs-18  list-unstyled">
                                                             <li>
                               ...
                               <div class="col-md-6 col-xl-3">
                                    <div class="card">
                                         ...
                                         <div class="card-body bg-light-subtle rounded-bottom">
                                              <a href="product-details.php" class="text-dark fw-medium fs-16">Kid's Yellow T-shirt</a>
                                              <div class="my-1">
                                                   <div class="d-flex gap-2 align-items-center">
                                                        <ul class="d-flex text-warning m-0 fs-18  list-unstyled">
                                                             <li>
                               ...
                               <div class="col-md-6 col-xl-3">
                                    <div class="card">
                                         ...
                                         <div class="card-body bg-light-subtle rounded-bottom">
                                              <a href="product-details.php" class="text-dark fw-medium fs-16">White Rubber Smart Watch</a>
                                              <div class="my-1">
                                                   <div class="d-flex gap-2 align-items-center">
                                                        <ul class="d-flex text-warning m-0 fs-18  list-unstyled">
                                                             <li>
                               ...
                               <div class="col-md-6 col-xl-3">
                                    <div class="card">
                                         ...
                                         <div class="card-body bg-light-subtle rounded-bottom">
                                              <a href="product-details.php" class="text-dark fw-medium fs-16">Men Brown Leather Shoes</a>
                                              <div class="my-1">
                                                   <div class="d-flex gap-2 align-items-center">
                                                        <ul class="d-flex text-warning m-0 fs-18  list-unstyled">
                                                             <li>
    ...
    <script src="assets/js/pages/ecommerce-product.js"></script>
</body>

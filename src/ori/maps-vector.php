...
<?php include 'partials/main-nav.php'; ?>
     ...
     <script src="assets/js/components/maps-us-aea-en.js"></script>
     <script src="assets/js/components/maps-us-lcc-en.js"></script>
     <script src="assets/js/components/maps-us-mill-en.js"></script>

                                    ...
                                    <table class="table table-hover mb-0 table-centered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>#US523</td>
                                                <td>24 April, 2024</td>
                                                <td><img src="assets/images/users/avatar-2.jpg" alt="avatar-2" class="img-fluid avatar-xs rounded-circle"> <span class="align-middle ms-1">Dan Adrick</span></td>
                                            ...
                                            <tr>
                                                <td>#US652</td>
                                                <td>24 April, 2024</td>
                                                <td><img src="assets/images/users/avatar-3.jpg" alt="avatar-2" class="img-fluid avatar-xs rounded-circle"> <span class="align-middle ms-1">Daniel Olsen</span></td>
                                                <td><span class="badge badge-soft-success">Verified</span></td>
                                                <td>@alliates </td>
                                            </tr>
                                            <tr>
                                                <td>#US862</td>
                                                <td>20 April, 2024</td>
                                                <td><img src="assets/images/users/avatar-4.jpg" alt="avatar-2" class="img-fluid avatar-xs rounded-circle"> <span class="align-middle ms-1">Jack Roldan</span></td>
                                            ...
                                            <tr>
                                                <td>#US756</td>
                                                <td>18 April, 2024</td>
                                                <td><img src="assets/images/users/avatar-5.jpg" alt="avatar-2" class="img-fluid avatar-xs rounded-circle"> <span class="align-middle ms-1">Betty Cox</span></td>
                                                <td><span class="badge badge-soft-success">Verified</span></td>
                                                <td>@reffon </td>
                                            </tr>
                                            <tr>
                                                <td>#US420</td>
                                                <td>18 April, 2024</td>
                                                <td><img src="assets/images/users/avatar-6.jpg" alt="avatar-2" class="img-fluid avatar-xs rounded-circle"> <span class="align-middle ms-1">Carlos Johnson</span></td>
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive table-centered">
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="apps-ecommerce-order-detail.php">#RB5625</a></td>
                                            <td>29 April 2024</td>
                                            <td><img src="assets/images/products/product-1(1).png" alt="product-1(1)" class="img-fluid avatar-sm"></td>
                                        ...
                                        <tr>
                                            <td><a href="apps-ecommerce-order-detail.php">#RB9652</a></td>
                                            <td>25 April 2024</td>
                                            <td><img src="assets/images/products/product-4.png" alt="product-4" class="img-fluid avatar-sm"></td>
                                        ...
                                        <tr>
                                            <td><a href="apps-ecommerce-order-detail.php">#RB5984</a></td>
                                            <td>25 April 2024</td>
                                            <td><img src="assets/images/products/product-5.png" alt="product-5" class="img-fluid avatar-sm"></td>
                                        ...
                                        <tr>
                                            <td><a href="apps-ecommerce-order-detail.php">#RB3625</a></td>
                                            <td>21 April 2024</td>
                                            <td><img src="assets/images/products/product-6.png" alt="product-6" class="img-fluid avatar-sm"></td>
                                        ...
                                        <tr>
                                            <td><a href="apps-ecommerce-order-detail.php">#RB8652</a></td>
                                            <td>18 April 2024</td>
                                            <td><img src="assets/images/products/product-1(2).png" alt="product-1(2)" class="img-fluid avatar-sm"></td>

<?php include 'partials/main.php' ?>
    ...
    <head>
        <?php
    $subTitle = "Apex Polar Area Charts";
                        ...
                        <div class="col-xl-9">
                           <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0"><span class="fw-medium">Find the JS file for the following chart at:</span> <code> assets/js/components/apexchart-polar-area.js</code></p>
                                </div><!-- end card-body -->
                            </div><!-- end card -->
